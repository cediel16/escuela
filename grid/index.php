...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/lib/flexigrid/css/flexigrid.css">
            <script type="text/javascript" src="http://code.jquery.com/jquery-1.5.2.min.js"></script>
            <script type="text/javascript" src="assets/lib/flexigrid/js/flexigrid.js"></script>
    </head>
    <body>
