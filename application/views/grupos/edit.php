    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="btn-group">
                    <?php echo anchor_popup('ayuda/view/grupos/edit', '<span class="text-success"><span class="icon icon-question-sign"></span></span> Ayuda', array('class' => 'btn btn-default btn-sm')) ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo script_tag('assets/js/grupos/edit.js') ?>